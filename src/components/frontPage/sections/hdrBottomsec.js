			...
			<div className="bg-gradient-to-r from-bg-top-hdr-bar-left to-bg-top-hdr-bar-right text-white pt-4">
				<div className="flex">
					...
					<div className="flex-none">
						<img
							alt="" style={imgCss} src="https://images.unsplash.com/photo-1573496130488-f3bd89d03653?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" />
					</div>
				</div>
			</div>
			<CardComp />
