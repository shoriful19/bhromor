	...
	return (
		<div className="grid grid-cols-2 justify-center">
			<section className="bg-gradient-to-r from-bg-top-hdr-bar-left to-bg-top-hdr-bar-right" style={imgContainerCss}>
				<img
					alt="" src="https://images.unsplash.com/photo-1573166364902-982ae58a27ae?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80"
